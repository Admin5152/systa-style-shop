...
export function FeaturedCarousel({ products, onAddToCart }: FeaturedCarouselProps) {
    ...
    >
      <div className="flex flex-col md:flex-row items-center gap-6 p-6 md:p-10">
        ...
        <div className="flex-1 text-center md:text-left space-y-4">
          ...
          <Button onClick={() => onAddToCart(currentProduct)} size="lg" className="w-full md:w-auto">
